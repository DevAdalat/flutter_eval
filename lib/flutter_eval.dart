...
import 'package:flutter_eval/src/material/switch.dart';
  ...
  void configureForRuntime(Runtime runtime) {
    runtime
      ...
      ..registerBridgeFunc(
        'package:flutter/src/widgets/framework.dart',
        'StatelessWidget.',
        $StatelessWidget$bridge.$new,
        isBridge: true,
      )
      ..registerBridgeFunc(
        'package:flutter/src/widgets/framework.dart',
        'StatefulWidget.',
        $StatefulWidget$bridge.$new,
        isBridge: true,
      )
      ..registerBridgeFunc(
        'package:flutter/src/widgets/framework.dart',
